...
- Do not include explanations, reasons, suggestions, markdown, code fences, or text outside JSON.
...
def grade_essay(
    ...
    messages = build_grading_messages(essay_text=essay_text, topic=topic, teacher_config=teacher_config)
